#ifndef CONFIG_STORE_UNINIT_VAR_H
#define CONFIG_STORE_UNINIT_VAR_H
...
public:
     ...
     */
    ConfigStoreUninitVar(int size = 10);

    /**
     * @brief Destructor, releases allocated memory
     */
    ~ConfigStoreUninitVar();
...
#endif // CONFIG_STORE_UNINIT_VAR_H